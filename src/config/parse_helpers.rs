...
use super::toml::{
    ...
    OutputRuleFile, WindowRuleFile,
};
use super::types::{
    BackendConfig, DecorationConfig, DecorationMode, EffectsConfig, OutputConfig, OutputMode,
    OutputOutlineSettings, OutputPosition, WindowRule,
};
...
pub(super) fn parse_window_rule(r: WindowRuleFile) -> Option<WindowRule> {
