...
- `widget` — true: immovable by hand (no drag, gesture or nudge) though `driftwm msg move` still repositions it, below normal windows, excluded from navigation and alt-tab (default: false)
